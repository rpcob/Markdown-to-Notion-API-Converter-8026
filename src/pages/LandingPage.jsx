...
const { FiArrowRight, FiCode, FiZap, FiShield, FiCheckCircle } = FiIcons;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Transform your Markdown content into Notion API-compatible JSON with our powerful, 
              secure REST API. Perfect for developers and content creators.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/docs"
                className="inline-flex items-center px-8 py-4 border-2 border-blue-200 text-blue-100 rounded-lg font-semibold hover:bg-blue-700 transition-colors"
              >
                View Documentation
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
              Join thousands of developers using our API to seamlessly integrate 
              Markdown content into their Notion workflows.
            </p>
            <Link
              to="/register"
              className="inline-flex items-center px-8 py-4 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors"
